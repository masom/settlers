...
from settlers.engine.components.spawner import Spawner, SpawnerPipeline, SpawnerOutput
...
def build_house(name: str, components: List[tuple]) -> Building:
    house_storages = {
    ...
    house = Building("House", house_storages, renderable_type="building_house")
