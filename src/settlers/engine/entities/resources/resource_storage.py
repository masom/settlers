...
class ResourceStorage:
    ...
    def __init__(
        ...
        self._storage: List[Type[Resource]] = []

    def add(self, item: Type[Resource]) -> bool:
    ...
    def pop(self) -> Type[Resource]:
        return self._storage.pop()

    def remove(self, item: Type[Resource]) -> Optional[Type[Resource]]:
